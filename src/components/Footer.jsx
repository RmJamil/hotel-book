...
import logo from '../../src/assets/log3.png'
const Footer = () => {
    return (
        <div className='lg:my-12'>
          <footer className="flex flex-row justify-around p-3 footer bg-sky-400 sm:footer-horizontal rounded-t-2xl text-base-content lg:p-10 mt-8">
  <nav>
