...
const Main = () => {
  ...
  console.log(rooms);
    ...
    return (
        <div>
            ...
            <div>
                 <p className='text-center my-6 text-3xl text-sky-500 font-bold'>Top Review</p>
 ...
 itemTemplate={Carouse} />
           ...
           <div>
            ...
            <MapView/>
            <p className='italic text-3xl font-bold mt-4 ml-4 text-sky-500'>Address:</p>
            <p className='text-5xl font-bold mt-4 ml-24 text-red-700'>Hotel Jeal <span className='text-xl text-green-400' >(5 Star hotel)</span></p>
           
            <p className='text-2xl font-bold  ml-34'>
